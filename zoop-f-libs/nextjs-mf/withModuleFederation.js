...
const withModuleFederation = (config, options, mfConfig) => {
  ...
  const federationConfig = {
    ...
    remotes: options.isServer ? nextServerRemote(mfConfig.remotes) : mfConfig.remotes,
  ...
  config.plugins.push(new options.webpack.container.ModuleFederationPlugin(federationConfig));
